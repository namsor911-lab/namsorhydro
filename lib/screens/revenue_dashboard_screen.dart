...
class _RevenueDashboardScreenState extends State<RevenueDashboardScreen> {
  ...
  final List<_MonthlyRevenue> _data2025 = [
    _MonthlyRevenue(month: 1,  energyUSD: 1540.0, capacityUSD: 375.0, penaltyUSD: 0,     mwh: 28300, status: 'ຊຳລະແລ້ວ'),
    _MonthlyRevenue(month: 2,  energyUSD: 1380.0, capacityUSD: 375.0, penaltyUSD: 80.0,  mwh: 25100, status: 'ຊຳລະແລ້ວ'),
    _MonthlyRevenue(month: 3,  energyUSD: 1620.0, capacityUSD: 375.0, penaltyUSD: 0,     mwh: 30200, status: 'ຊຳລະແລ້ວ'),
    _MonthlyRevenue(month: 4,  energyUSD: 1710.0, capacityUSD: 375.0, penaltyUSD: 120.0, mwh: 31800, status: 'ຊຳລະແລ້ວ'),
    _MonthlyRevenue(month: 5,  energyUSD: 1671.0, capacityUSD: 375.0, penaltyUSD: 120.0, mwh: 30770, status: 'ລໍຖ້າ'),
    _MonthlyRevenue(month: 6,  energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
    _MonthlyRevenue(month: 7,  energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
    _MonthlyRevenue(month: 8,  energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
    _MonthlyRevenue(month: 9,  energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
    _MonthlyRevenue(month: 10, energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
    _MonthlyRevenue(month: 11, energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
    _MonthlyRevenue(month: 12, energyUSD: 0,      capacityUSD: 0,     penaltyUSD: 0,     mwh: 0,     status: 'ຍັງບໍ່ມີ'),
  ];
  ...
  Widget _tableHeader() {
    return Container(
      ...
      child: Row(children: [
        const Expanded(flex: 2, child: Text('ເດືອນ',
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700,
                color: AppColors.textSecondary))),
        const Expanded(flex: 3, child: Text('Energy (USD)',
            textAlign: TextAlign.right,
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700,
                color: AppColors.textSecondary))),
        const Expanded(flex: 3, child: Text('Capacity (USD)',
            textAlign: TextAlign.right,
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700,
                color: AppColors.textSecondary))),
        const Expanded(flex: 2, child: Text('MWh',
            textAlign: TextAlign.right,
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700,
                color: AppColors.textSecondary))),
        const Expanded(flex: 3, child: Text('ລວມ (USD)',
            textAlign: TextAlign.right,
            style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700,
                color: AppColors.textSecondary))),
        const SizedBox(width: 60, child: Text('ສະຖານະ',
  ...
  Widget _buildRecentInvoices() {
    final recent = [
      _InvoiceRef('INV-2025-05-0042', 'EDL', 'USD 2,118.60', 'ລໍຖ້າ',   '30/06/2025'),
      _InvoiceRef('INV-2025-04-0038', 'EDL', 'USD 1,965.00', 'ຊຳລະແລ້ວ', '30/05/2025'),
      _InvoiceRef('INV-2025-03-0031', 'EDL', 'USD 2,210.50', 'ຊຳລະແລ້ວ', '30/04/2025'),
      _InvoiceRef('INV-2025-02-0024', 'EDL', 'USD 1,898.00', 'ຊຳລະແລ້ວ', '31/03/2025'),
    ];
