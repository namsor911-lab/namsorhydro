...
class _ProductionDialogState extends State<ProductionDialog> with SingleTickerProviderStateMixin {
  ...
  Widget _buildManualVsAutoCard(DailyMeterData? data) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [const Icon(Icons.compare_arrows, color: _Op.info, size: 13), const SizedBox(width: 6), const Text('ປຽບທຽບ: ອັດຕະໂນມັດ vs ມິເຕີ (ປ້ອນດ້ວຍມື)', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: _Op.textLo))]),
        const SizedBox(height: 8),
        headerRow(),
        _subLabel('🟢 MAIN METER'),
