...
// =========================================================
// ໃຊ້ສີດຽວກັນກັບ load_screen.dart
// =========================================================
...
// =========================================================
// MODEL — ຂໍ້ມູນທີ່ຈະສົ່ງຈາກ LoadScreen ເຂົ້າມາ
// =========================================================
...
// =========================================================
// ສະຫຼຸບຂໍ້ມູນລ່າສຸດ (ຕົວເລກທີ່ຖືກປ້ອນສຸດທ້າຍ) ຂອງແຕ່ລະວັນ
// =========================================================
...
// =========================================================
// SCREEN — ສະແດງປະຫວັດການຜະລິດຕາມເດືອນທີ່ເລືອກ (referenceDate)
// =========================================================

class ProductionHistoryScreen extends StatefulWidget {
  final Map<String, List<EnergyRow>> dataByDate;
  // ວັນທີອ້າງອີງ (ມາຈາກວັນທີ່ພະນັກງານເລືອກຢູ່ໜ້າ Load Screen)
  // ໃຊ້ກຳນົດວ່າຈະສະແດງຂໍ້ມູນຂອງ "ເດືອນ" ໃດ
...
class _ProductionHistoryScreenState extends State<ProductionHistoryScreen> {
  ...
  // ເພີ່ມ ScrollController ສຳລັບເຮັດວຽກຮ່ວມກັບ Scrollbar ເທິງ Flutter Web
  ...
  @override
  void dispose() {
    _horizontalScrollController.dispose(); // ລ້າງ ScrollController ເພື່ອປະຢັດຄວາມຈຳ
    super.dispose();
  }

  List<DailySummary> _buildSummaries() {
    final ref = widget.referenceDate;
    // ນັບຈຳນວນວັນຂອງເດືອນທີ່ເລືອກໄວ້ (ຮອງຮັບທຸກເດືອນ ບໍ່ວ່າ 28/29/30/31 ວັນ)
    final daysInMonth = DateTime(ref.year, ref.month + 1, 0).day;
    final List<DailySummary> result = [];

    // ສະແດງຈາກວັນທີ 1 ໄລ່ໄປຫາວັນສຸດທ້າຍຂອງເດືອນ (ນ້ອຍຫາໃຫຍ່)
  ...
  Widget _buildTableCard() {
    return LayoutBuilder(
      builder: (context, constraints) {
        // ຖ້າຈໍກວ້າງພໍ (>= ຄວາມກວ້າງຕ່ຳສຸດທີ່ອ່ານອອກໄດ້) ໃຫ້ຄອລັມຂະຫຍາຍເຕັມຈໍ
        // ຖ້າຈໍແຄບກວ່ານັ້ນ (ເຊັ່ນມືຖື) ໃຫ້ໃຊ້ຄວາມກວ້າງຄົງທີ່ ແລະ ເລື່ອນຊ້າຍ-ຂວາແທນ
        ...
        // ຈໍກວ້າງພໍ → ສະແດງເຕັມຄວາມກວ້າງ ບໍ່ຕ້ອງເລື່ອນ
        if (fitsFullWidth) {
          return card;
        }

        // ຈໍແຄບ → ຫໍ່ດ້ວຍ horizontal scroll
        return Scrollbar(
  ...
  // ຄວາມກວ້າງແຕ່ລະຄອລັມຂອງຕາຕະລາງ (ໃຊ້ຮ່ວມກັນລະຫວ່າງ _buildTable ແລະ _buildTableCard
  // ເພື່ອໃຫ້ກ່ອງ border ບີບພໍດີກັບຄວາມກວ້າງຕາຕະລາງແທ້ໆ ບໍ່ມີຊ່ອງຫວ່າງເຫຼືອທາງຂວາ)
  static const double _dateW = 100;
  static const double _timeW = 65;
  static const double _numW = 90;
  static const double _smallW = 75;

  // ຈຳນວນຄອລັມ: date(1) + time(1) + main/backup meter(8) + summary(5) = 15
  ...
  Widget _buildTable({bool useFlex = false}) {
    ...
    // useFlex = true: ຄອລັມຂະຫຍາຍຕາມສັດສ່ວນເພື່ອໃຫ້ເຕັມຄວາມກວ້າງຈໍ
    // useFlex = false: ຄອລັມຄວາມກວ້າງຄົງທີ່ (ໃຊ້ເມື່ອຈໍແຄບ ຕ້ອງເລື່ອນຊ້າຍ-ຂວາ)
  ...
  // ປຽບທຽບວ່າວັນທີ່ນັ້ນແມ່ນ "ມື້ນີ້" ແທ້ໆ (ຕາມເວລາລະບົບ) ຫຼືບໍ່
